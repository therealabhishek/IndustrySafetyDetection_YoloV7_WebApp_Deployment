import os,sys
import yaml
from industrysafe.utils.main_utils import read_yaml_file
import urllib.request as request
from industrysafe.logger import logging
from industrysafe.exception import IndustryException
from industrysafe.constants.training_pipeline import *
from industrysafe.entity.config_entity import ModelTrainerConfig
from industrysafe.entity.artifact_entity import ModelTrainerArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,) -> ModelTrainerArtifact:
        ...
        try: 
            ...
            request.urlretrieve(url, os.path.join("yolov7", file_name))
